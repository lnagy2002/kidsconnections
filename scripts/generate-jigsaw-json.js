/**
 * Generates kid-friendly daily Jigsaw images WITHOUT external AI calls.
 * Writes: docs/data/jigsaw-MMDDYYYY.json
 * Output format: { easy: [dataURL...], medium: [...], hard: [...] }
 *
 * Usage:
 *   node scripts/generate-jigsaw-json.js --count 3 --outDir docs/data --date 2025-09-15 --seed 42
 *
...
(async () => {
  try {
    ...
    const outFile = path.join(outDir, `jigsaw-${stamp}.json`);
